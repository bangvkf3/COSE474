...
class ResNet:
    def __init__(self, config):
        ...
        self._relu_leakiness = config.relu_leakiness # default : leakiness=0.0
        ...
        self._weight_init = config.weight_init
        ...
        with tf.variable_scope('init'): # 최초 convolutional layer
          x = self._conv('init_conv', self.X, filter_size=3, in_filters=3, out_filters=16, strides=[1, 1, 1, 1])
    ...
    def _stddev(self, weight_init, n):
        if weight_init == 'He':
    ...
    def _conv(self, name, x, filter_size, in_filters, out_filters, strides):
        with tf.variable_scope(name):
            ...
            kernel = tf.get_variable(
                ...
                tf.float32, initializer=tf.random_normal_initializer(stddev=self._stddev(self._weight_init, n)))
