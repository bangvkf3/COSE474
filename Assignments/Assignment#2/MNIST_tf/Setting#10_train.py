...
W4 = tf.get_variable("W4", shape=[200, 200], initializer=tf.contrib.layers.variance_scaling_initializer())
b4 = tf.Variable(tf.random_normal([200]))
L4 = tf.nn.relu(tf.matmul(L3, W4) + b4)

W5 = tf.get_variable("W5", shape=[200, 10], initializer=tf.contrib.layers.variance_scaling_initializer())
