...
class LeNet:
    def __init__(self, config):
        ...
        self.W1 = tf.Variable(tf.random_normal([5, 5, 3, 6], stddev=0.02)) # HE: stddev=sqrt(2/5*5*6)
        ...
        # (14, 14, 6) feature map
        self.W2 = tf.Variable(tf.random_normal([5, 5, 6, 16], stddev=0.02)) # HE: stddev=sqrt(2/5*5*16)
